...
if (isset($_GET['approve'])) {
    ...
    if (mysqli_query($conn, $updateSql)) {
        ...
        if ($userRow) {
            ...
            echo "No user found for this project.";
        }
    } else {
        echo "<p class='text-danger'>Error updating project: " . mysqli_error($conn) . "</p>";
    }
    header("Location: manage_projects.php");
    exit;
}
...
if (isset($_GET['comment_action']) && isset($_GET['comment_id'])) {
    ...
    if (!$commentUserResult) {
        echo "Error executing comment user query: " . mysqli_error($conn);
        exit;
    }
    ...
    if ($commentUserRow) {
        ...
        echo "No user found for this comment.";
    }
}
                ...
                <div id="comments-<?php echo $row['project_id']; ?>" class="collapse">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="email" name="comment_email" class="form-control mt-2" placeholder="Your Email" required>
